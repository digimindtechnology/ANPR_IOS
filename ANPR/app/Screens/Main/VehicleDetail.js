...
export default class VehicleData extends Component {
  ...
  static navigationOptions = ({ navigation }) => {
    return {
        title:navigation.getParam('vehicle_data').LicenseNum,
         ...
         {this.state.vehicle_Detail && this.state.vehicle_Detail!=="" ?
          ...
          <LabelView label='Owners Detail' style={{backgroundColor:'white'}}>
                <View style={{borderRadius:5,opacity:5,padding:5}}>
                   ...
                   <View style={{flexDirection:"row",borderBottomWidth:0,borderBottomColor:'#e6e6ff',marginTop:10,paddingBottom:10}}>
                        <View style={{width:'40%'}}>
          ...
          <LabelView label='Vehicle Detail' style={{backgroundColor:'white'}}>
                <View style={{borderRadius:5,opacity:5,padding:5}}>
                   ...
                   <View style={{flexDirection:"row",borderBottomWidth:0,borderBottomColor:'#e6e6ff',marginTop:10,paddingBottom:10}}>
                        <View style={{width:'40%'}}>
                            <Text style={{color:'black'}}>LP Category</Text> 
                        </View>
                        <View style={{width:'60%',alignItems:'flex-end'}}>
                           <Text style={{marginLeft:10,textAlign:'right'}}></Text>
                        </View>
                   </View>
